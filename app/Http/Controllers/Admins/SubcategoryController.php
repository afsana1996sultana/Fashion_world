...
class SubcategoryController extends Controller
{
    public function index()
    {
        ...
        return view("pages.backends.sub-categories.index",["subcategories"=>$subcategories, "categories"=>$categories, "status"=>$status]);
    ...
    public function store(Request $request){
        ...
        $subcategories->sub_c_name=$request->txtSubCategoryName;
