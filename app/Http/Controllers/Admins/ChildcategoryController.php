...
class ChildcategoryController extends Controller
{
    public function index()
    {
        ...
        $childcategories =DB::table('childcategories')
             ...
             ->select('childcategories.*','categories.c_name','subcategories.sub_c_name','statuses.s_name')
             ->get();   
        return view("pages.backends.child-categories.index",["childcategories"=>$childcategories, "categories"=>$categories, "subcategories"=>$subcategories, "status"=>$status]);
    ...
    public function store(Request $request){
        ...
        $childcategories->child_c_name=$request->txtChildCategory;
