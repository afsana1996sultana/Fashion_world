	...
	<section class="section">
		<div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="{{url('/category')}}">Category</a></div>
              <div class="breadcrumb-item active"><a href="{{url('/sub-category')}}">Sub Category</a></div>
                        ...
                        <table class="table table-striped" id="table-1">
                            ...
                            <tbody> 
                                ...
                                <tr class="odd">
                                    ...
                                    <td>{{$childcategories-> child_c_name}}</td>
                                    <td>{{$childcategories-> slug}}</td>
                                    <td><i class="{{$childcategories-> icon}}"></i></td>
                                    <td>{{$childcategories-> sub_c_name}}</td>
		...
		$(document).on('click','#editchildcategories',function(){
			...
			$.ajax({
				...
				success:function(response){
					...
					$('#eChildCategory').val(response.childcategories.child_c_name);
