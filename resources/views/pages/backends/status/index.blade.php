...
<div class="main-content">
	...
	<div class="row">
        <div class="col-auto float-right ml-auto pb-2" >
            <a href="#" class="btn btn-primary btn-block" data-toggle="modal" data-target="#add_status"><i class="fa fa-plus"></i>Add New</a> 
        </div>
	</div>
	<!-- /Page Header -->
    <div class="row">
								...
								<tr class="odd">
									...
									<td class="text-right py-0 align-middle">
										<div class="btn-group btn-group-sm">
											<button type="button" value="{{$status->id}}" class="btn btn-primary" id="editstatus" ><i class="fas fa-edit" ></i> </button>&nbsp;
		...
		$(document).on('click','#editstatus',function(){
			...
			$.ajax({
				...
				success:function(response){
					$('#cmbStatusId').val(eid);		
					$('#eName').val(response.status.s_name);
